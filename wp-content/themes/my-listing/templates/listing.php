                ...
                <div class="col-md-12">
                    <div class="profile-menu">
                        <ul class="cts-carousel">
                            ...
                            endforeach; ?><?php                             $link_tour= $listing->get_field( 'video_url' );                             if( (isset( $link_tour) && ($link_tour!=''))  ){?>                                                        <a href="<?=$_SERVER["REDIRECT_URL"];?>?r=1">                            <i style="font-size: 24px;" class="icon-location-user"></i></a>                            <? } ?>                                                  <?   $link_video= $listing->get_field( 'yutuver' );                             if( (isset( $link_video) && ($link_video!=''))  ){?>                                                      <a href="<?=$_SERVER["REDIRECT_URL"];?>?r=2">                            <i style="font-size: 24px; margin-left:10px;" class="fab fa-youtube "></i> </a>                             <? } ?>                            <? if($_GET['r']!='4')  {?>                                                            <a href="<?=$_SERVER["REDIRECT_URL"];?>?r=3">                            <i style="font-size: 24px; margin-left:10px;" class="fa fa-images"></i> </a>                            <? } ?>                            <?   $link_visao_rua= $listing->get_field( 'viso-da-rua' );                             if( (isset( $link_visao_rua) && ($link_visao_rua!=''))  ){?>                                                      <a href="<?=$_SERVER["REDIRECT_URL"];?>?r=4">                         <i style="font-size: 24px; margin-left:10px;" class="fa fa-map"></i>Visão Da Rua </a>                          </a>                             <? } ?>
